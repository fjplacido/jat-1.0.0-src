 ...
 * method in class <code>Runtime</code>. <br>
...
public class ContainerController {
	 ...
	 * meaningfully called from application code. The proper way to create an agent
	 ...
	 * 
	 * @param nickname  A platform-unique nickname for the newly created agent. The
	 *                  agent will be given a FIPA compliant agent identifier using
	 *                  the nickname and the ID of the platform it is running on.
	 * @param className The fully qualified name of the class that implements the
	 *                  agent.
	 * @param args      An object array, containing initialization parameters to
	 *                  pass to the new agent.
	 * @return A proxy object, allowing to call state-transition forcing methods on
	 *         the real agent instance.
	 */
	 ...
	 * @return An AgentController, allowing to call state-transition forcing methods
	 ...
	 *                  format.
	 * @param className The fully qualified name of the Java class that implements
	 ...
	 *                                <code>ContainerController</code> is not valid
	 *                                or is not the platform Main Container.
	 */
	...
	public void selectiveShutDown(Vector survivers) {
		myImpl.selectiveShutDown(survivers);
	}
